...
def transform_3d_to_2d(box3ds):
    ...
    for idx, box3d in enumerate(box3ds):
        ...
        # import pdb; pdb.set_trace()
        # horizontal_indices = 1023 -horizontal_indices
...
def parse_config():
    ...
    parser.add_argument("--fps_distance", type=int, default=5) #default = 4 # farthest_point_sampling # for near object (# of points so about near object == large computation of clustering)
        ...
        if selected_id == None or selected_id == -1:
            if pred_dicts[0]['pred_labels'].shape[0] != 0:
                ...
                try:
                    ...
                    box3d_cls = _pred_dicts_[0]['pred_labels'].reshape(-1, 1) # (class_id) #1:ped, 3:car, 6:bus, 8:truck, -> 0, 2, 5, 7
                    ...
                    print("img topic is None or YOLO is not setup yet")
...
if __name__ == '__main__':
    ...
    # for yolo node ========================================================
    bridge = CvBridge()
    # model_2d = torch.hub.load("ultralytics/yolov5", "yolov5m")
    # model_2d = torch.hub.load("ultralytics/yolov5", "yolov5l")
    model_2d = torch.hub.load("ultralytics/yolov5", "yolov5m6")
    # model_2d = torch.hub.load("ultralytics/yolov5", "custom", "/home/changwon/data_2/hanwha_projects/hanwha_sot/hanwha_sot_v2/src/hanwha_sot/scripts/yolov5l.engine")
