            ...
            if pred_dicts[0]['pred_labels'].shape[0] != 0:
                ...
                try:
                    ...
                    if best_M_sorted.shape[0] > 0: #2D-3D fusion
                        ...
                        pub_dicts[0]['pred_boxes'] = _pred_dicts_[0]['pred_boxes'][:args.num_candidate, :]
                        pub_dicts[0]['pred_scores'] = _pred_dicts_[0]['pred_scores'][:args.num_candidate]
                        pub_dicts[0]['pred_labels'] = _pred_dicts_[0]['pred_labels'][:args.num_candidate]
                        pub_dicts[0]['pred_id'] = _pred_dicts_[0]['pred_id'][:args.num_candidate]
