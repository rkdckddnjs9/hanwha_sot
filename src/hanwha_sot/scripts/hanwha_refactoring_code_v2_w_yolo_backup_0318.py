...
class ros_demo():
    ...
    def online_inference(self, msg):
        ...
        global last_box_num, pred_dicts_sot, init_h, temp_, viz_dicts, prev_pred_dicts_mot
        ...
        try:
            ...
            imgees = nearir_img_
            # result_2d_1 = model_2d(img_stack, size=(128, 1024)) # for tensorrt
