...
from extend_kalman import TrackedObject
...
class ros_demo():
    ...
    def online_inference(self, msg):
        global selected_id, _pred_dicts_, tracklet_nums, PCs, temp_selected_id, count, sot_list, velo
        ...
        if selected_id == None:
            ...
            try:
                ...
                # Extract the measurement (position) from the detected object
                measurement = pred_dicts_[0]['pred_boxes'][slc_idx][:3]
                sot_list.append(measurement)
                if len(sot_list) >=2:
                    velo = sot_list[-2] - sot_list[-1]
                else:
                    pass
                ...
                count += 1
                # _pred_dicts_[0]['pred_boxes'] = _pred_dicts_[0]['pred_boxes']
                _pred_dicts_[0]['pred_boxes'][0, :3] = _pred_dicts_[0]['pred_boxes'][0, :3] + velo
